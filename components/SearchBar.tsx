  ...
  return (
    <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 w-full max-w-2xl mx-auto">
      <div className="relative w-full sm:flex-grow group">
        {/* Search Icon */}
        <div className="absolute inset-y-0 left-0 pl-4 sm:pl-5 flex items-center pointer-events-none transition-colors duration-300 group-focus-within:text-orange-400">
          <svg
        ...
        <input
          ...
          className="w-full pl-11 sm:pl-14 pr-4 py-3 text-base sm:text-lg 
            bg-stone-900/80 backdrop-blur-sm text-stone-100 placeholder-stone-500 
            border border-stone-700 rounded-xl 
            focus:outline-none focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500 
            focus:shadow-[0_0_15px_rgba(234,88,12,0.15)] 
